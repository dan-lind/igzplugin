...
import com.danlind.igz.ig.api.client.rest.dto.application.updateApplicationV1.UpdateApplicationV1Request;
import com.danlind.igz.ig.api.client.rest.dto.clientsentiment.getClientSentimentV1.GetClientSentimentV1Response;
import com.danlind.igz.ig.api.client.rest.dto.clientsentiment.getRelatedClientSentimentV1.GetRelatedClientSentimentV1Response;
...
import com.danlind.igz.ig.api.client.rest.dto.history.getActivityHistoryV1.GetActivityHistoryV1Response;
import com.danlind.igz.ig.api.client.rest.dto.history.getActivityHistoryV3.GetActivityHistoryV3Response;
import com.danlind.igz.ig.api.client.rest.dto.history.getTransactionHistoryByTimeRangeV1.GetTransactionHistoryByTimeRangeV1Response;
import com.danlind.igz.ig.api.client.rest.dto.history.getTransactionHistoryV2.GetTransactionHistoryV2Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsListV1.GetMarketDetailsListV1Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsV1.GetMarketDetailsV1Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsV2.GetMarketDetailsV2Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.navigation.getMarketNavigationNodeV1.GetMarketNavigationNodeV1Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.getPositionByDealIdV1.GetPositionByDealIdV1Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.getPositionsV1.GetPositionsV1Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.getPositionsV2.GetPositionsV2Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.closeOTCPositionV1.CloseOTCPositionV1Request;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.createOTCPositionV1.CreateOTCPositionV1Request;
...
import com.danlind.igz.ig.api.client.rest.dto.positions.sprintmarkets.createSprintMarketPositionV1.CreateSprintMarketPositionV1Response;
import com.danlind.igz.ig.api.client.rest.dto.prices.getPricesByDateRangeV1.GetPricesByDateRangeV1Response;
import com.danlind.igz.ig.api.client.rest.dto.prices.getPricesByDateRangeV2.GetPricesByDateRangeV2Response;
import com.danlind.igz.ig.api.client.rest.dto.prices.getPricesByNumberOfPointsV1.GetPricesByNumberOfPointsV1Response;
import com.danlind.igz.ig.api.client.rest.dto.session.createSessionV1.CreateSessionV1Request;
import com.danlind.igz.ig.api.client.rest.dto.session.createSessionV1.CreateSessionV1Response;
import com.danlind.igz.ig.api.client.rest.dto.session.createSessionV2.CreateSessionV2Response;
...
import com.danlind.igz.ig.api.client.rest.dto.session.updateActiveAccountV1.UpdateActiveAccountV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.deleteWatchlistV1.DeleteWatchlistV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.getWatchlistsV1.GetWatchlistsV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.updateWatchlistMarketV1.UpdateWatchlistMarketV1Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.getWorkingOrdersV1.GetWorkingOrdersV1Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.createOTCWorkingOrderV1.CreateOTCWorkingOrderV1Request;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.createOTCWorkingOrderV1.CreateOTCWorkingOrderV1Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.createOTCWorkingOrderV2.CreateOTCWorkingOrderV2Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.deleteOTCWorkingOrderV1.DeleteOTCWorkingOrderV1Request;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.deleteOTCWorkingOrderV1.DeleteOTCWorkingOrderV1Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.updateOTCWorkingOrderV1.UpdateOTCWorkingOrderV1Request;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.updateOTCWorkingOrderV1.UpdateOTCWorkingOrderV1Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.updateOTCWorkingOrderV2.UpdateOTCWorkingOrderV2Response;
import com.danlind.igz.ig.api.client.rest.dto.application.updateApplicationV1.UpdateApplicationV1Response;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.danlind.igz.ig.api.client.rest.dto.application.getApplicationsV1.GetApplicationsV1ResponseItem;
import com.danlind.igz.ig.api.client.rest.dto.history.getActivityHistoryByTimeRangeV1.GetActivityHistoryByTimeRangeV1Response;
import com.danlind.igz.ig.api.client.rest.dto.history.getActivityHistoryV2.GetActivityHistoryV2Response;
import com.danlind.igz.ig.api.client.rest.dto.history.getTransactionHistoryV1.GetTransactionHistoryV1Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsBySearchTermV1.GetMarketDetailsBySearchTermV1Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsListV2.GetMarketDetailsListV2Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsV3.GetMarketDetailsV3Response;
import com.danlind.igz.ig.api.client.rest.dto.markets.navigation.getMarketNavigationRootV1.GetMarketNavigationRootV1Response;
...
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.createOTCPositionV1.CreateOTCPositionV1Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.updateOTCPositionV1.UpdateOTCPositionV1Request;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.updateOTCPositionV1.UpdateOTCPositionV1Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.sprintmarkets.createSprintMarketPositionV1.CreateSprintMarketPositionV1Request;
import com.danlind.igz.ig.api.client.rest.dto.positions.sprintmarkets.getSprintMarketPositionsV1.GetSprintMarketPositionsV1Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.sprintmarkets.getSprintMarketPositionsV2.GetSprintMarketPositionsV2Response;
import com.danlind.igz.ig.api.client.rest.dto.prices.getPricesByNumberOfPointsV2.GetPricesByNumberOfPointsV2Response;
...
import com.danlind.igz.ig.api.client.rest.dto.session.updateActiveAccountV1.UpdateActiveAccountV1Request;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.createWatchlistV1.CreateWatchlistV1Request;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.createWatchlistV1.CreateWatchlistV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.deleteWatchlistMarketV1.DeleteWatchlistMarketV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.getWatchlistByWatchlistIdV1.GetWatchlistByWatchlistIdV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.updateWatchlistMarketV1.UpdateWatchlistMarketV1Request;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.getWorkingOrdersV2.GetWorkingOrdersV2Response;
import com.danlind.igz.ig.api.client.rest.dto.workingorders.otc.createOTCWorkingOrderV2.CreateOTCWorkingOrderV2Request;
...
public class RestAPI extends AbstractService {
    ...
    */
    public UpdateApplicationV1Response updateApplicationV1(ConversationContext conversationContext, UpdateApplicationV1Request request) throws Exception {
    ...
    */
    public com.danlind.igz.ig.api.client.rest.dto.application.disable.updateApplicationV1.UpdateApplicationV1Response updateApplicationV1(ConversationContext conversationContext) throws Exception {
        String uri = "/operations/application/disable";
        HttpEntity<?> requestEntity = buildHttpEntity(conversationContext, null, "1");
        ResponseEntity<com.danlind.igz.ig.api.client.rest.dto.application.disable.updateApplicationV1.UpdateApplicationV1Response> response = restTemplate.exchange(getIGApiDomainURL() + addIGApiLightDarkCluster(uri), HttpMethod.PUT, requestEntity, com.danlind.igz.ig.api.client.rest.dto.application.disable.updateApplicationV1.UpdateApplicationV1Response.class);
        return response.getBody();
    }
