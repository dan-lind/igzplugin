...
public class TimeConvert {
    ...
    public static LocalDateTime localDateTimeFromOLEDate(final double oleTime, int offset) {
        return LocalDateTime.ofInstant(dateTimeFromOLEDate(oleTime)
                .toInstant(ZoneOffset.UTC), ZoneOffset.ofHours(offset));
