...
import com.danlind.igz.ig.api.client.rest.dto.markets.getMarketDetailsV2.MarketOrderPreference;
import com.danlind.igz.ig.api.client.rest.dto.positions.getPositionsV2.GetPositionsV2Response;
import com.danlind.igz.ig.api.client.rest.dto.positions.getPositionsV2.PositionsItem;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.closeOTCPositionV1.CloseOTCPositionV1Request;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.closeOTCPositionV1.TimeInForce;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.createOTCPositionV1.CreateOTCPositionV1Request;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.createOTCPositionV1.Direction;
import com.danlind.igz.ig.api.client.rest.dto.positions.otc.createOTCPositionV1.OrderType;
...
import com.danlind.igz.ig.api.client.rest.dto.watchlists.getWatchlistByWatchlistIdV1.MarketStatus;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.getWatchlistByWatchlistIdV1.MarketsItem;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.getWatchlistsV1.GetWatchlistsV1Response;
import com.danlind.igz.ig.api.client.rest.dto.watchlists.getWatchlistsV1.WatchlistsItem;
...
public class Application implements CommandLineRunner {
   ...
   public void run(String... args) throws Exception {
      ...
      System.exit(SpringApplication.exit(applicationContext, () -> app.run(user, password, apiKey) ? 0 : 1));
   }
...
//         }
   ...
   private void closeOpenPosition(String dealId, String direction, BigDecimal size, String expiry) throws Exception {
      ...
      closePositionRequest.setDirection(com.danlind.igz.ig.api.client.rest.dto.positions.otc.closeOTCPositionV1.Direction.valueOf(direction));
      closePositionRequest.setSize(size);
      closePositionRequest.setExpiry(expiry);
      if(marketDetails.getDealingRules().getMarketOrderPreference() != MarketOrderPreference.NOT_AVAILABLE) {
         closePositionRequest.setOrderType(com.danlind.igz.ig.api.client.rest.dto.positions.otc.closeOTCPositionV1.OrderType.MARKET);
      } else {
         closePositionRequest.setOrderType(com.danlind.igz.ig.api.client.rest.dto.positions.otc.closeOTCPositionV1.OrderType.LIMIT);
